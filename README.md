...
1.0.0-rc.5 细化雨中庭院的水滴与播放动效：主水滴采用偏斜的柔和轮廓、透明的水体和断续反光，周围六颗水珠有不同的大小、曲率与缓慢形变，文字和按钮保持稳定。播放水波逐渐舒展、减速和消散，浏览其他推荐时仍会继续。保留网易云 / B 站搜索、喜欢后自动下载、七首音乐树及歌词功能。先看 [普通使用说明](docs/getting-started.zh-CN.md)，验收证据与限制见 [1.0 验收记录](docs/1.0-readiness.zh-CN.md)。
