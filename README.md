...
0.3.0-rc.1 增加「初遇」新手引导：空音乐库即有 14 首起始推荐，带你完成试听、喜欢、查看下载结果；自动整理名称与查找歌词可在引导中选择。已有用户可从设置打开。新电脑仍需要准备下载组件，引导会显示缺项。详见 [首次体验与 1.0 就绪清单](docs/1.0-readiness.zh-CN.md)。
