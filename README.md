...
1.0.0-rc.1 提供空库初遇歌单与新手引导、一键下载环境准备、自动名称整理和歌词、备份恢复及诊断导出。喜欢会进入后台下载队列，完成校验后出现在音乐树中。先看 [普通使用说明](docs/getting-started.zh-CN.md)，验收证据与限制见 [1.0 验收记录](docs/1.0-readiness.zh-CN.md)。
