...
# ends.
param(
    [string[]]$StateSuites = @('Core', 'Database', 'V2', 'WorkerConcurrency', 'DownloadPipeline', 'Recommendation', 'LegacyRetirement', 'Listening', 'Web', 'Tauri', 'ConfigurableLibrary', 'TestRunner', 'Identity'),
