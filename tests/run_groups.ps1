...
# ends.
param(
    [string[]]$StateSuites = @('Core', 'Database', 'V2', 'WorkerConcurrency', 'DownloadPipeline', 'Management', 'Onboarding', 'Recommendation', 'LegacyRetirement', 'Listening', 'Web', 'Tauri', 'ConfigurableLibrary', 'TestRunner', 'Identity'),
    [string[]]$ApiSuites = @('Http', 'UiProxyRuntime', 'MediaRuntime', 'OnboardingRuntime', 'ApiTransaction', 'ApiRuntime'),
