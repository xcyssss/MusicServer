...
# ends.
param(
    [string[]]$StateSuites = @('Core', 'Database', 'V2', 'WorkerConcurrency', 'DownloadPipeline', 'Onboarding', 'Recommendation', 'LegacyRetirement', 'Listening', 'Web', 'Tauri', 'ConfigurableLibrary', 'TestRunner', 'Identity'),
